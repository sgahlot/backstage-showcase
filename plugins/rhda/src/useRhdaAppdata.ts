...
export const useRhdaAppData = () => {
  ...
  if (!repositorySlug) {
    error = {
      message:
        "RHDA: Missing 'github.com/project-slug' annotation in catalog-info.yaml.",
      name: 'Missing annotation project-slug',
    };
  }
  ...
  if (!manifestFilePath) {
    error = {
      message:
        "RHDA : Missing 'rhda/manifest-file-path' annotation in catalog-info.yaml",
      name: 'Missing annotation manifest-file-path',
    };
  }
